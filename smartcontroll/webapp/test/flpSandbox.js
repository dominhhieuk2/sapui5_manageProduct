		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Smart controll app",
									"targetURL": "#smartcontroll-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"smartcontroll-display": {
								"semanticObject": "smartcontroll",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=smartcontroll",
									"url": sap.ui.require.toUrl("smartcontroll")
								}
							}
						}
					}
